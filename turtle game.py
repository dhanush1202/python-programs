...
while start1<=end or start2 <= end:
    if start1>= end:
        wn.title(f"Player1 position is {start1},"
                 f"player2 position is {start2}, player1 wins")
        time.sleep(5)
        break
    elif start2>=end:
        wn.title(f"Player1 position is {start1},"
                 f"player2 position is {start2}, player2 wins")
        time.sleep(5)
        break
    ...
    start1 += dice1*2
    start2 += dice2*2
    wn.title(f"player position is {start1},"
             f"player2 position is {start2}, no one wins")
time.sleep(3)
turtle.bye()